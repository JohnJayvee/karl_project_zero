			...
			<div class="box-content">
				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
				  ...
				  <?php 
						...
						$user_data = get_section_join($table_name,$table_name2, "strand_id");
						...
						//fetch result set and pass it to an array (associative)
				  		...
				  		$strand_id =$row['strand_initials'];
				  		$year_level_id = $row['year_level'];
				  		$school_yr = $row['year'];
						//$studid = get_studid_from_id(id)
				  		$edit_user_url = base_url().'section_edit.php?id='.$section_id;
				  		$delete_user_url = base_url().'section_deleteconf.php?id='.$section_id;
				  ...
				  ?>
					...
					<td class="center"><?= $year_level_id ?></td>
						...
						<td class="center">
							...
							<a class="btn btn-primary" href="<?= $edit_user_url ?>">Edit </a>
